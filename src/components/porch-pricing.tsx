...
const PorchPricing = () => {
    ...
    const handleOptionChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
      ...
      router.push(`porch-models/?selectedOption=${optionValue}`);
    };
...
<div className="">
<h1 className="mb-4 text-2xl font-extrabold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">{getSize(selectedOption)} PORCH MODELS</h1>
<Stars></Stars>
