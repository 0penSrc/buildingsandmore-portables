...
const EndGablePorchPricing = () => {
  ...
  const handleOptionChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    router.push(`end-gables-porch/?selectedOption=${optionValue}`);
  };
                  ...
                  const getFinance = (option: string) => {
                      switch (option) {
                        ...
                        const getStripeLink = (option: string) => {
                          switch (option) {
                            case "10x10":
                              return "https://buy.stripe.com/6oE2asbdlcXC2rK29X";
                            case "10x12":
                              return "https://buy.stripe.com/aEU9CUbdlg9O2rK7ug";
                            case "10x14":
                              return "https://buy.stripe.com/aEUg1ibdl3n2easg0L";
                            case "10x16":
                              return "https://buy.stripe.com/00g3ew4OX5va0jC7ue1";
                            case "10x20":
                              return "https://buy.stripe.com/aEU5mEa9h0aQ8Q87ud";
                            case "10x24":
                              return "https://buy.stripe.com/5kAcP66X5cXC7M4aGo";
                            case "12x12":
                              return "https://buy.stripe.com/aEU9CU5T15vagiAeWD";
                            case "12x14":
                              return "https://buy.stripe.com/bIY2as4OXe1G1nG9Ci";
                            case "12x16":
                              return "https://buy.stripe.com/5kA5mE5T10aQeas8yd";
                            case "12x20":
                              return "https://buy.stripe.com/eVa8yQftBaPu1nG9Cg";
                            case "12x24":
                              return "https://buy.stripe.com/14k9CU8190aQ5DW15J";
                            case "12x30":
                              return "https://buy.stripe.com/5kAaGYftB5vaeas9Ce";
                            case "12x32":
                              return "https://buy.stripe.com/eVa3ewdltaPu2rK5lX";
                            case "12x36":
                              return "https://buy.stripe.com/3csbL25T18Hm7M4aGg";
                            case "12x40":
                              return "https://buy.stripe.com/00gaGYftB0aQgiA01B";
                            case "12x44":
                              return "https://buy.stripe.com/cN2aGY3KT5va6I0bKi";
                            case "14x24":
                              return "https://buy.stripe.com/5kA7uM6X53n22rK9C9";
                            case "14x30":
                              return "https://buy.stripe.com/cN202k0yH7Di1nG15C";
                            case "14x32":
                              return "https://buy.stripe.com/8wM02k4OX0aQ1nGaGb";
                            case "14x36":
                              return "https://buy.stripe.com/8wMeXe4OX2iYc2kcOi";
                            case "14x40":
                              return "https://buy.stripe.com/eVa02k6X54r68Q815z";
                            case "14x44":
                              return "https://buy.stripe.com/aEUg1igxF2iY7M401u";   
                              default:
                                return "#";
                            }
                          };
...
<div className="">
<h1 className="mb-4 text-2xl font-extrabold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">{getSize(selectedOption)} END GABLE PORCH</h1>
<Stars></Stars>
...
export default EndGablePorchPricing