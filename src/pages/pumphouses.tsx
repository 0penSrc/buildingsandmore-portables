...
import PumpHousePricing from "~/components/pumphouse-pricing";
import FooterHero from "~/components/footer-hero";
import FeaturedProducts from "~/components/featured-products";
import GAnalytics from '~/components/ganalytics';

const PumpHouses: NextPage = () => {
    return (
      <>
        <Head>
          <title>Pumphouses | Buildings and More</title>
          <meta name="description" content="Pumphouses - Buildings and More Portable Buildings" />
