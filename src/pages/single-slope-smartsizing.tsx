...
import SingleSlopeSmartSidingPricing from "~/components/single-slope-smartsizing-pricing";
import FooterHero from "~/components/footer-hero";
import FeaturedProducts from "~/components/featured-products";
import GAnalytics from '~/components/ganalytics';

const SingleSlopeSmartSiding: NextPage = () => {
    return (
      <>
        <Head>
          <title>Single Slope Smart Siding | Buildings and More</title>
...
<div className="dark:bg-gray-800 dark:text-gray-100">
	<div className="container max-w-6xl px-10 py-6 mx-auto rounded-lg shadow-sm bg-gray-200">
		...
		<div className="mt-3">
			...
			<p className="mt-2 text-gray-800">Standard w/ 36&#34;x72&#34; fiberglass door, wood frame, Galvalume Steel Roofing secured to steel hat channel. One slope roof design with roof to slope from one sidewall to other sidewall. 7&#39; wall height standard on low side, high side 1&#39; higher than low side. Add 10% for 7&#39;6&#34; Wall Height, Add 4% for steel frame. Shingle roof is not an available option with this low slope roof design. Add $10.50 per perimeter foot for 3&#34; eave with soffit and fascia trim.</p>
		</div>
	</div>
</div>
</section>
...
<FeaturedProducts/>
  ...
  export default SingleSlopeSmartSiding;