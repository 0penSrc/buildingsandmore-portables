...
import EndGablePorchPricing from "~/components/end-gable-porch";
import FooterHero from "~/components/footer-hero";
import FeaturedProducts from "~/components/featured-products";
import GAnalytics from '~/components/ganalytics';

const EndGablePorch: NextPage = () => {
    return (
      <>
        <Head>
          <title>End Gables with Porches | Buildings and More</title>
