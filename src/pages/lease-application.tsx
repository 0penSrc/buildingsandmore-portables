...
const LeasingApp: NextPage = () => {
  return (
    <>
      <Head>
        <title>Leasing Application | Buildings and More</title>
    ...
    <h2 className="mb-2 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white text-center mt-8">Lease Application</h2>
      <LeaseForm/>
      <Footer />
    </>
  );
